# Simme : RoboMaster 视觉算法验证模拟器

这是一个专为 **Phoenix战队** 开发的 **RoboMaster 视觉算法验证模拟器**，用于在虚拟环境中测试和验证机器人视觉算法。特别鸣谢:Actor&Thinker 战队的Blackjack200，本项目在其基础上进行改进和扩展，去除了ROS依赖
...
- **作者**: Blackjack200 Gunian7
- **团队**: Actor&Thinker 战队 Phoenix 战队
- **技术栈**: Rust + Bevy + ROS2
